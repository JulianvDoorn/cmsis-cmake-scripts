...
set(TOOLCHAIN_SYSROOT  "${STM32_TOOLCHAIN_PATH}/${TARGET_TRIPLET}")
set(TOOLCHAIN_BIN_PATH "${STM32_TOOLCHAIN_PATH}/bin")
set(TOOLCHAIN_INC_PATH "${STM32_TOOLCHAIN_PATH}/${TARGET_TRIPLET}/include")
set(TOOLCHAIN_LIB_PATH "${STM32_TOOLCHAIN_PATH}/${TARGET_TRIPLET}/lib")
...
find_program(CMAKE_CPPFILT NAMES ${TARGET_TRIPLET}-c++filt HINTS ${TOOLCHAIN_BIN_PATH})
